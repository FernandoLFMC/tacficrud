...
@Entity
@Table(name = "equiposcomputacion")
public class Equiposcomputacion {
	...
	public Equiposcomputacion() {
		super();
	}
	public Equiposcomputacion(long id_activo, String marca, String nro_serial, String color, String tipo,
			String industria) {
		super();
